...
// Import the 'SearchFormIn' component from the specified path
import SearchFormIn from './SearchFormIn'; // Update this path as needed

const NewStockInPage = () => { // Define a functional component named 'NewStockInPage'
    ...
    // Define styles for the title with a dark blue border, padding, and square corners
    const titleStyle = {
    ...
    // Define styles for the button with a dark blue background and white text
    const buttonStyle = {
    ...
    return (
        <div style={containerStyle}> {/* Render a div with the container style */}
            ...
            <div style={titleStyle}>
                新建入库记录 {/* Display the text '新建入库记录' */}
            </div>
...
export default NewStockInPage; // Export the 'NewStockInPage' component
