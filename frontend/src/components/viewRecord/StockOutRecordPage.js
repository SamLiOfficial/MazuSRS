...
// Define the StockOutRecordPage functional component
const StockOutRecordPage = () => {
    ...
    const [records, setRecords] = useState([]); // State for stock out records
    ...
    const handleSubmit = async () => {
        try {
            // Send GET request to fetch stock out statistics based on start and end dates
    ...
    const handleDelete = async (recordId) => {
        try {
            // Send DELETE request to delete stock out record by record ID
    ...
    const handleSaveEdit = async (editedRecord) => {
        try {
            // Send PUT request to update stock out record with edited data
    ...
    // Return JSX for rendering the StockOutRecordPage component
    return (
        <div>
            {/* Heading for the StockOutRecordPage */}
            ...
            {/* Table for displaying stock out records */}
...
// Export the StockOutRecordPage component as default
